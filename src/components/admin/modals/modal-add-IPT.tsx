...
import { AlertTriangle, UserCog, UserX } from "lucide-react";
...
function ModalAddIPTMember({ refetch, isOpen, setIsOpen }: ModalProps) {
  ...
  const closeModal = useCallback(
    (closeModal: boolean) => {
      ...
      if (closeModal) submitAddIpt();
    },
    [setIsOpen, submitAddIpt]
  );
...
export default ModalAddIPTMember;
